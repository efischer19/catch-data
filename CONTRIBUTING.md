...
When making significant decisions, we use [Architecture Decision Records (ADRs)](./meta/adr/ADR-001-use_adrs.md). Please review existing ADRs before proposing changes that may conflict with accepted decisions.

## Code of Conduct

All participants are expected to follow our [Code of Conduct](./CODE_OF_CONDUCT.md). Please be respectful and considerate in all your interactions.
