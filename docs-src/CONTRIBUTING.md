...
First off, thank you for your interest in catch-data! We're excited
you're here.
...
catch-data follows a specific, AI-assisted workflow:
...
[Code of Conduct](https://github.com/efischer19/catch-data/blob/main/CODE_OF_CONDUCT.md).
