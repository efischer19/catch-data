...
This document outlines the ethical principles that govern all data gathering, scraping, and API interaction conducted by the `catch-data` project. Our goal is to build useful software while acting as good citizens of the digital world. Adherence to these principles is mandatory for all code, whether generated by AI or written by humans. Our project's long-term viability depends on the trust and respect we show to the data sources we rely on.

The primary data source for this project is the **MLB Stats API** (`statsapi.mlb.com`). All principles below apply specifically to interactions with that API and any other MLB-related data sources.
...
* **Example `User-Agent`:** `catch-data/0.1 (+https://github.com/efischer19/catch-data)`
